...
// paths but not tsconfig `@/*` aliases. The shared zod contract lives in src/lib.
import { generateColumnsInputSchema } from "../../src/lib/assistant-schemas";

export default defineTool({
  description: `Use this tool to generate column definitions for a spreadsheet. This tool creates the structure (columns) of a spreadsheet based on user requirements.

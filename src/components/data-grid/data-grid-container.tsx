...
import { filterValueSchema } from "@/lib/data-grid-filters";
...
export function DataGridContainer<T extends DataGridRowData>({
  ...
  const onColumnsGenerated = React.useCallback(
    (newColumns: ColumnDef<DataGridFeatures, DataGridRowData>[]) => {
      ...
      // Add new columns
      // SAFETY: columns generated by the assistant describe a runtime schema:
      // they are accessor-key defs over string keys, so they address `T`
